...
func (in *CycleSettings) DeepCopyInto(out *CycleSettings) {
	*out = *in
	...
	in.DaemonsetPodsToRemove.DeepCopyInto(&out.DaemonsetPodsToRemove)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DaemonsetPodsToRemove) DeepCopyInto(out *DaemonsetPodsToRemove) {
	*out = *in
	if in.NodeLabelsToRemove != nil {
		in, out := &in.NodeLabelsToRemove, &out.NodeLabelsToRemove
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.DaemonsetPodsLabelsToWait != nil {
		in, out := &in.DaemonsetPodsLabelsToWait, &out.DaemonsetPodsLabelsToWait
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DaemonsetPodsToRemove.
func (in *DaemonsetPodsToRemove) DeepCopy() *DaemonsetPodsToRemove {
	if in == nil {
		return nil
	}
	out := new(DaemonsetPodsToRemove)
	in.DeepCopyInto(out)
	return out
}
